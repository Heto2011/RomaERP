...
public class EmployeeService : IEmployeeService
{
    ...
    private static EmployeeDto Map(Employee e) => new()
    {
        ...
        DepartmentNameAr = e.Department?.NameAr ?? string.Empty,
        DepartmentNameEn = e.Department?.NameEn ?? string.Empty,
        PositionId = e.PositionId,
        PositionNameAr = e.Position?.TitleAr ?? string.Empty,
        PositionNameEn = e.Position?.TitleEn ?? string.Empty,
